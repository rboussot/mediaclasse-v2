...
ActiveRecord::Schema.define(version: 20190728143753) do
  ...
  create_table "subcomments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comment_id"], name: "index_subcomments_on_comment_id", using: :btree
    t.index ["user_id"], name: "index_subcomments_on_user_id", using: :btree
  end
